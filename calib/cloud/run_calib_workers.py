...
SHARED_DIR = "/shared"
USE_WRAPPER = (
    False  # Whether to use the runtime wrapper. If True, will create a directory with the job name and pod name in the shared directory.
)
...
container = client.V1Container(
    ...
    env=[
        ...
        client.V1EnvVar(name="JOB_NAME", value=cfg.job_name),
        client.V1EnvVar(
